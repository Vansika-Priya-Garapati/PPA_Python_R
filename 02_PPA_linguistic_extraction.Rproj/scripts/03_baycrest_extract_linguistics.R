# ===============================================================================================================================================================
# Baycrest PPA Corpus | 03_baycrest_extract_linguistics.R
...
# 2. File Paths
raw_cha_dir <- "data/baycrest_cha" # Show R where data is
...
message(paste("Found", length(cha_files), "file(s). Processing PPA features...")) # Displays how many .cha files found - need to find 10
...
output_file <- path(output_dir, "ppa_baycrest_linguistic_features.csv") # file destination path
