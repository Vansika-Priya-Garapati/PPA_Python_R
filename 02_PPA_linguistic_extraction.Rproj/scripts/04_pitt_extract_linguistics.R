# ===============================================================================================================================================================
# DementiaBank English Pitt Corpus | 04_pitt_extract_linguistics.R
...
# 2. File Paths
raw_cha_dir <- "data/pitt_cha" # Show R where data is
...
message(paste("Found", length(cha_files), "file(s). Processing Control features...")) # Displays how many .cha files found - need to find 243
...
output_file <- path(output_dir, "control_pitt_linguistic_features.csv") # file destination path
